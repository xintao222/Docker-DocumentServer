...
exports.install = function(server, callbackFunction) {
  var sockjs_echo = sockjs.createServer(cfgSockjs),
    urlParse = new RegExp("^" + cfgEnvSubpath + "/doc/([" + constants.DOC_ID_PATTERN + "]*)/c.+", 'i');
  ...
  sockjs_echo.installHandlers(server, {prefix: cfgEnvSubpath + '/doc/['+constants.DOC_ID_PATTERN+']*/c', log: function(severity, message) {
    logger.info(message);
  }});
